 ...
 */
final class Version20210412140956 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, author_id INT NOT NULL, meme_id INT NOT NULL, content VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
